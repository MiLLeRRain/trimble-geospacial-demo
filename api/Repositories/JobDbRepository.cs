...
public sealed class JobDbRepository
{
    ...
    // Smoke test used by POST /api/v1/jobs/_test
    public async Task<JobDbResponse> SmokeTestInsertAndSelectAsync(CancellationToken cancellationToken)
    {
